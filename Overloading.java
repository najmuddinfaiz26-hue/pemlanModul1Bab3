...
public class Overloading {
    ...
    public static void HitungLuas(int a, int b) {
        System.out.println("maka hasil luas : " + (a * b));
    }
    ...
    public static void HitungLuasVoid(double value, double value2) {
    ...
    public static void main(String[] args) {
        ...
        // pertanyaan A3 - panggil yang versi void
        HitungLuasVoid(double1, double2);
